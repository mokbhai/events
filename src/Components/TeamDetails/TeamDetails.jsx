...
// const inputFeildCss =
//   "w-full border px-3 py-2 bg-slate-300 text-black rounded-lg";
...
//       className="border text-slate-300 p-4 flex flex-col"
//     >
//       {/* Team Name */}
//       <div className="mb-4">
...
const TeamDetails = ({ teamDetails, setTeamDetails }) => {
  ...
  return (
    <div className="gap-5 border p-4 opacity-80">
      <h2 className="text-2xl font-bold mb-4 text-center">Team Details</h2>
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
        {teamDetails.teamMembers.map((member, index) => (
          <div key={index} className="mb-4">
            {/* Show "Team Leader" for the first member */}
            {index === 0 && (
              <div className="text-lg font-bold mb-2 text-red-500 underline ">
                Team Leader*
              </div>
            )}
            {index == 1 && (
            ...
            <input
              ...
              className="w-full border px-3 py-2 bg-slate-300 text-black rounded mb-2"
            />
            <select
              value={member.class}
              onChange={(e) =>
