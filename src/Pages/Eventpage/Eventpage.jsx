...
const EventPage = () => {
  ...
  return (
    <>
      <div
        className="bg-cover bg-center bg-fixed bg-black text-slate-300"
            ...
            <div className="px-4 flex flex-col lg:flex-col gap-8 rounded-xl border-2 border-blue-600 shadow relative">
              ...
              <div className="flex flex-col lg:flex-row ">
                  ...
                  <div className="text-center lg:text-left rounded-xl flex flex-col items-center lg:items-start bg-transparent text-slate-300">
                    ...
                    <div className="flex flex-col items-center lg:items-start w-full mb-8 lg:mb-16">
                      <div className="flex-col">
                        <p className="font-avenger tracking-widest text-red-600 text-xl sm:text-2xl ">
                          Description:
                        </p>
                    ...
                    <div className="w-full flex flex-col gap-7 mb-8 lg:mb-16">
                      <div className="flex flex-col justify-center gap-3  w-full">
                        ...
                        <ul className="list-outside list-disc text-lg sm:text-xl text-start tracking-wider w-full">
                          {event.rules &&
                            event.rules
                              .slice(0, showMoreRules ? event.rules.length : 2)
                              .map((rule, index) => (
                                <li key={index}>{rule}</li>
                              ))}
                        </ul>
                      ...
                      <div className="flex flex-col sm:flex-row justify-evenly items-center gap-3 w-full">
                        ...
                        {event.ruleBook && (
                          <div>
                            <button
                              className="bg-red-700 text-slate-300 font-avenger tracking-widest text-sm sm:text-base md:text-lg  py-2 px-4 rounded-full"
                        ...
                        {event.brochure && (
                          <button
                            className="w-fit bg-red-700 text-slate-300 font-avenger tracking-widest text-sm sm:text-base md:text-lg  py-2 px-4 rounded-full"
                ...
                <div className="lg:w-1/2 flex flex-col justify-between p-5">
                  ...
                  <button
                    className="absolute top-5 right-5 bg-red-600 h-fit text-slate-300 py-2 px-2 font-avengerd font-semibold rounded border-2 border-blue-950 z-10"
                    onClick={handleShare}
                  >
                    Share
                  </button>
                  ...
                  <div className="mt-2 text-center lg:text-left">
                    ...
                    <div className="flex flex-col md:flex-row justify-around mb-3">
                      <div className="mr-3 flex flex-row">
                        <p className="font-avenger tracking-widest text-red-600 text-xl sm:text-2xl mr-2">
                          Day:
                        </p>
                    ...
                    <div className=" flex flex-col mb-5 ">
                      <h4 className="font-avenger tracking-widest text-red-600 text-xl sm:text-2xl ">
                        Contact:
                      </h4>
                      {event.contacts &&
                        event.contacts.map((contact, index) => (
                          <div
                            key={index}
                            className="flex flex-row text-lg sm:text-xl gap-2"
                          >
                            <p>
                    ...
                    <div className="w-full flex justify-center mt-5">
                      <button
                        className="w-full sm:w-1/2 hero text-lg sm:text-xl md:text-2xl lg:text-3xl text-black font-extrabold tracking-widest bg-blue-400 py-2 px-4 font-avenger rounded-full border-2 border-blue-950"
