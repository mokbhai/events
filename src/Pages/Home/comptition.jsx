...
const CompetitionSchedule = () => {
  ...
  return (
    <div className="text-slate-500 font-avenger uppercase min-h-screen lg:h-screen m-3 border rounded-xl shadow overflow-hidden bg-gradient-to-r from-black to-slate-900">
      <div className="flex flex-col lg:flex-row justify-center items-center h-full">
        <div className="w-fit lg:w-1/2 h-full p-4 sm:p-2 flex flex-col items-center justify-evenly">
          <h1 className=" sm:text-5xl md:text-5xl lg:text-7xl font-avenger text-center mb-3 text-slate-300">
            Competitions
          </h1>
            ...
            <table className=" uppercase p-0 text-md w-fit tracking-widest h-full">
              <thead>
                <tr className={bgGrad}>
                  ...
                  <th className="border-l-4 p-3 border-slate-300" colSpan="2">
                    Day 2
                  </th>
                </tr>
              </thead>
              <tbody className="">
                <tr className={bgGrad}>
                  <th className="p-2 bg-gray-800" colSpan="4">
                    MORNING
                  </th>
                </tr>
                    ...
                    {row.map((cell, cellIndex) => (
                      <td
                        ...
                        className={`uppercase p-3 font-semibold ${
                          cellIndex === 2 ? "border-l-4 border-slate-300" : ""
                        }`}
                      >
                        {cell}
                      </td>
            ...
            <table className=" uppercase p-0 text-md w-fit tracking-widest h-full">
              <thead>
                <tr className={bgGrad}>
                  ...
                  <th className="border-l-4 p-3 border-slate-300" colSpan="1">
                    Day 2
                  </th>
                </tr>
              </thead>
                  ...
                  >
                    {row.map((cell, cellIndex) => (
                      <td
                        key={cellIndex}
                        className={`uppercase p-3 font-semibold ${
                          cellIndex === 1 ? "border-l-4 border-slate-300" : ""
                        }`}
                      >
                        {cell}
                      </td>
